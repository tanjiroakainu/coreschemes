...
import { MdOutlineAssignmentTurnedIn, MdNotificationsActive } from 'react-icons/md';
...
export default function SectionHeadLayout() {
      ...
      >
        ...
        <div className="flex flex-col h-full mt-4 ">
          ...
          <nav className="space-y-2 flex-1 ">
            ...
            />
            <SidebarLink
              href="/section-head/assignment-notification"
